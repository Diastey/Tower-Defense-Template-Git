...
//[CreateAssetMenu(fileName = "TargetLockedState", menuName = "Scriptable Objects/States/TargetLockedState")]
public class TargetLockedState : StateBehavior
{
    ...
    public override void FramesUpdate(StateManagers stateManager, StateMachine stateMachine)
    {
        ...
        //{
        //    //ResetFire(gunManager);
        //    stateMachine.ChangeState(StateEnum.ATTACK, gunManager, stateMachine);
        //}

        //if (energyRechargeTimer <= 0.0f)
        //{
        //    stateMachine.ChangeState(StateEnum.IDLE, gunManager, stateMachine);
        //}
    }
